  ...
  const loadTasks = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Datos de fallback
        setTasks([
          { id: '1', subject: 'Matemáticas', title: 'Quiz de Álgebra', dueDate: 'Mañana', status: 'pending' },
          { id: '2', subject: 'Ciencias', title: 'Experimento de Física', dueDate: 'En 3 días', status: 'in_progress' },
          { id: '3', subject: 'Español', title: 'Ensayo Literario', dueDate: 'En 5 días', status: 'pending' },
        ]);
      }
    } catch (error) {
  ...
  const loadSubjectProgress = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Datos de fallback
        setSubjectProgress([
          { subject: 'Matemáticas', progress: 85, grade: 4.3 },
          { subject: 'Ciencias', progress: 92, grade: 4.6 },
          { subject: 'Español', progress: 78, grade: 3.9 },
          { subject: 'Historia', progress: 88, grade: 4.4 },
        ]);
      }
    } catch (error) {
